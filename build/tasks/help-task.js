...
module.exports = function (grunt) {
    ...
    grunt.registerTask('help', 'prints out the grunt tasks that are registered', function () {
        ...
        printDefinition('default', 'uglifies gidget, then runs the unit tests on the uglified code, and finally copies the uglified files to example directories if the unit tests pass', '-os');
        printDefinition('build', 'uglifies gidget and copies the uglified files to example directories');
        printDefinition('test', 'runs the browser side (karma) developer tests.', '-os');
        ...
        printExample('$ grunt test -os windows');
        console.log('');
    });
};
